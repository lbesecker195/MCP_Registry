# GitHub MCP Registry onboarding request (draft)

GitHub's MCP registry (github.com/mcp) is curated. Servers must first be in the
...
servers for review, without an account. It mirrors the official registry every
six hours.
